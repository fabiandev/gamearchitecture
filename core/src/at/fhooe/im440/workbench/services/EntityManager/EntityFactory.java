...
public class EntityFactory implements Service {
	...
	public Entity createCogwheel(float x, float y) {
		...
		return this.createEntity(TestEntity.class, new StaticPose(x, y), spriteVisual, new CircleCollider(1f), new CollisionMarker());
	}
	...
	public Entity createBar(float x, float y) {
		...
		return this.createEntity(TestEntity.class, new StaticPose(x, y), spriteVisual, new BoxCollider(5f, .5f), new CollisionMarker());
	}
